...
public class ContentFragmentServiceImpl implements ContentFragmentService{
    ...
    public List<AlertContentFragmentEntity> getContentFragmentData() throws LoginException {
        ...
        String contentFragmentParentPath = "/content/dam/training-project/content-fragment";
        ResourceResolver resourceResolver = getResourceResolver();
        Resource resource = resourceResolver.getResource(contentFragmentParentPath);
        if(resource != null){
